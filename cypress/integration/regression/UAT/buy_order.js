...
describe('PlayNow/buy_order', () => {
    ...
    it('Buy_order',()=>{
          ...
          //buy order
         cy.xpath('//*[@id="root"]/div/div/div/main/div[4]/div[1]/button').click()
         cy.wait(5000)
          ...
          //check the text
          cy.xpath('//*[@id="modal"]/div[3]/main/h1').contains('You left the battlefield')
          cy.xpath('//*[@id="modal"]/div[3]/main/h5').contains('A man that flies from his fear may find that he has only taken a short cut to meet it');
